      ...
      <div className="header">
        <div>
          ...
          <p className="meta-note" style={{ marginTop: 4 }}>
            Note: Walmart publishes fee/commission data roughly every 2 weeks, so orders from the
            last ~1-2 weeks may show $0 in fees until Walmart settles them. Refresh later to see
            updated numbers once they're published - this isn't a bug, it's how Walmart reports
            this data.
          </p>
        </div>
